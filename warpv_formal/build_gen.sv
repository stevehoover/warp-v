...
// For |fetch/instr/original$dest_reg_valid.
wire FETCH_Instr_Original_dest_reg_valid_a3;
...
// For |fetch/instr/original_ld$dest_reg_valid.
wire FETCH_Instr_OriginalLd_dest_reg_valid_a0;
reg  FETCH_Instr_OriginalLd_dest_reg_valid_a1,
     FETCH_Instr_OriginalLd_dest_reg_valid_a2,
     FETCH_Instr_OriginalLd_dest_reg_valid_a3;
...
// For |mem/data$dest_reg_valid.
wire MEM_Data_dest_reg_valid_a3;
reg  MEM_Data_dest_reg_valid_a4;
...
generate
   ...
   //
      ...
      //
         ...
         //
            ...
            // For $dest_reg_valid.
            always @(posedge clkP_FETCH_Instr_returning_ld_a1) FETCH_Instr_OriginalLd_dest_reg_valid_a1 <= FETCH_Instr_OriginalLd_dest_reg_valid_a0;
            always @(posedge clkP_FETCH_Instr_returning_ld_a2) FETCH_Instr_OriginalLd_dest_reg_valid_a2 <= FETCH_Instr_OriginalLd_dest_reg_valid_a1;
            always @(posedge clkP_FETCH_Instr_returning_ld_a3) FETCH_Instr_OriginalLd_dest_reg_valid_a3 <= FETCH_Instr_OriginalLd_dest_reg_valid_a2;
   ...
   //
      ...
      //
         ...
         // For $dest_reg_valid.
         always @(posedge clk) MEM_Data_dest_reg_valid_a4 <= MEM_Data_dest_reg_valid_a3;
