...
set designfile risc-v_4-stage
set design warp-v_risc-v_4-stage
set cons Vivado/warpv_constraints.xdc


#
# STEP#1: define output directory area.
#
set outputDir Vivado/out
...
set fid [open Vivado/out/FreqArea.txt a+]
puts -nonewline $fid "LUTs = "
